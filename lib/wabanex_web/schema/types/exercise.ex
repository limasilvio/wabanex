defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :protocol_description, non_null(:string), description: "Description of the protocol"
    field :repetitions, non_null(:string), description: "Repetitions for the exercise"
  end
end
